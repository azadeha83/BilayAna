...
tailcarbons_of = {
    ...
    'DUPC': [['C22', 'C22', 'C23', 'C24', 'C25', 'C26', 'C27', 'C28','C29', 'C210','C211', 'C212','C213', 'C214', 'C215', 'C216', 'C217','C218'],
             ['C32', 'C32', 'C33', 'C34', 'C35', 'C36', 'C37', 'C38','C39', 'C310','C311', 'C312','C313', 'C314', 'C315', 'C316', 'C317','C318']],
                  }
...
scd_tail_atoms_of = {\
    ...
    'DUPC':[['C21', 'C22', 'C24', 'C26', 'C28', 'C211', 'C214', 'C216', 'C218'], # Double bonds between 9-10, 12-13
            ['C31', 'C32', 'C34', 'C36', 'C38', 'C311', 'C314', 'C316', 'C318']],
    'CHL1':[['C3', 'C17']],
    'CHIM':[['C20', 'C12']],
    'ERG':[['C3', 'C17']],
                    }
