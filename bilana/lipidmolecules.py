...
TAILHYDR = {
    'DP':[['H2R', 'H2S','H3R', 'H3S', 'H4R', 'H4S', 'H5R', 'H5S', 'H6R', 'H6S','H7R','H7S','H8R',
    ...
    'DU':[['H2R', 'H2S','H3R', 'H3S', 'H4R', 'H4S', 'H5R', 'H5S', 'H6R', 'H6S','H7R','H7S','H8R',
             ...
             ['H2X', 'H2Y','H3X', 'H3Y','H4X', 'H4Y','H5X', 'H5Y', 'H6X', 'H6Y','H7X', 'H7Y','H8X',
                'H8Y', 'H9X', 'H10X', 'H11X', 'H11Y', 'H12X', 'H13X',
...
#                }
SCD_TAIL_ATOMS_OF = {\
    'DP':[HEADATM['DP'][0][::2], HEADATM['DP'][1][::2]],
    'DU':[['C22', 'C24', 'C26', 'C28', 'C211', 'C214', 'C216', 'C218'], # Double bonds between 9-10, 12-13
            ['C32', 'C34', 'C36', 'C38', 'C311', 'C314', 'C316', 'C318']],
    'DM':[[HEADATM['DM'][0][::2], HEADATM['DM'][1][::2]]],
    'DS':[[HEADATM['DS'][0][::2], HEADATM['DS'][1][::2]]],
    'DY':[['C22', 'C24', 'C26', 'C28', 'C211', 'C213' 'C215', ],   # Double bonds between 9-10
            ['C32', 'C34', 'C36', 'C38', 'C311', 'C313', 'C315',]],
    'PL':[['C22', 'C24', 'C26', 'C28', 'C211', 'C214', 'C216', 'C218'], HEADATM['PL'][1][::2]],
    'PO':[['C22', 'C24', 'C26', 'C28', 'C211', 'C213' 'C215', 'C217'], HEADATM['PO'][1][::2]],
